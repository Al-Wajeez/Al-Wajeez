...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function loadDataTable(data) {
        ...
        table.rows().every(function() {
            ...
            table.rows().every(function() {
                const rowData = this.data();
                sumArabic += parseFloat(rowData['اللغة العربية']) || 0;
                sumAmazigh += parseFloat(rowData['اللغة اﻷمازيغية']) || 0;
                sumFrench += parseFloat(rowData['اللغة الفرنسية']) || 0;
                sumEnglish += parseFloat(rowData['اللغة الإنجليزية']) || 0;
                sumIslamic += parseFloat(rowData['التربية الإسلامية']) || 0;
                sumCivics += parseFloat(rowData['التربية المدنية']) || 0;
                sumHistoryAndGeography += parseFloat(rowData['التاريخ والجغرافيا']) || 0;
                sumMath += parseFloat(rowData['الرياضيات']) || 0;
                sumNature += parseFloat(rowData['ع الطبيعة و الحياة']) || 0;
                sumPhysical += parseFloat(rowData['ع الفيزيائية والتكنولوجيا']) || 0;
                sumInformatics += parseFloat(rowData['المعلوماتية']) || 0;
                sumFine += parseFloat(rowData['التربية التشكيلية']) || 0;
                sumMusic += parseFloat(rowData['التربية الموسيقية']) || 0;
                sumAthletic += parseFloat(rowData['ت البدنية و الرياضية']) || 0;
                sumRate += parseFloat(rowData['معدل الفصل 1']) || 0;
            ...
            $('#arabic-mean').text(meanArabic.toFixed(2));
            $('#amazigh-mean').text(meanAmazigh.toFixed(2));
            $('#french-mean').text(meanFrench.toFixed(2));
            $('#english-mean').text(meanEnglish.toFixed(2));
            $('#islamic-mean').text(meanIslamic.toFixed(2));
            $('#civics-mean').text(meanCivics.toFixed(2));
            $('#historyandgeography-mean').text(meanHistoryAndGeography.toFixed(2));
            $('#math-mean').text(meanMath.toFixed(2));
            $('#nature-mean').text(meanNature.toFixed(2));
            $('#physical-mean').text(meanPhysical.toFixed(2));
            $('#informatics-mean').text(meanInformatics.toFixed(2));
            $('#fine-mean').text(meanFine.toFixed(2));
            $('#music-mean').text(meanMusic.toFixed(2));
            $('#athletic-mean').text(meanAthletic.toFixed(2));
            $('#rate-mean').text(meanRate.toFixed(2));
            ...
            table.rows().every(function() {
                ...
                $('#arabic-countGTen, #arabic-countGTenSucces').text(countarabicGreaterThanTen);
                $('#amazigh-countGTen, #amazigh-countGTenSucces').text(countamazighGreaterThanTen);
                $('#french-countGTen, #french-countGTenSucces').text(countfrenchGreaterThanTen);
                $('#english-countGTen, #english-countGTenSucces').text(countenglishGreaterThanTen);
                $('#islamic-countGTen, #islamic-countGTenSucces').text(countislamicGreaterThanTen);
                $('#civics-countGTen, #civics-countGTenSucces').text(countcivicsGreaterThanTen);
                $('#historyandgeography-countGTen, #historyandgeography-countGTenSucces').text(counthistoryandgeographyGreaterThanTen);
                $('#math-countGTen, #math-countGTenSucces').text(countmathGreaterThanTen);
                $('#nature-countGTen, #nature-countGTenSucces').text(countnatureGreaterThanTen);
                $('#physical-countGTen, #physical-countGTenSucces').text(countphysicalGreaterThanTen);
                $('#informatics-countGTen, #informatics-countGTenSucces').text(countinformaticsGreaterThanTen);
                $('#fine-countGTen, #fine-countGTenSucces').text(countfineGreaterThanTen);
                $('#music-countGTen, #music-countGTenSucces').text(countmusicGreaterThanTen);
                $('#athletic-countGTen, #athletic-countGTenSucces').text(countathleticGreaterThanTen);
                $('#rate-countGTen, #rate-countGTenSucces').text(countrateGreaterThanTen);

                // Update the content of the HTML elements with the counts and percentages
                $('#arabic-percentageGTen, #arabic-percentageGTenSucces').text(percentageArabicGreaterThanTen.toFixed(2) + "%");
                $('#amazigh-percentageGTen, #amazigh-percentageGTenSucces').text(percentageAmazighGreaterThanTen.toFixed(2) + "%");
                $('#french-percentageGTen, #french-percentageGTenSucces').text(percentageFrenchGreaterThanTen.toFixed(2) + "%");
                $('#english-percentageGTen, #english-percentageGTenSucces').text(percentageEnglishGreaterThanTen.toFixed(2) + "%");
                $('#islamic-percentageGTen, #islamic-percentageGTenSucces').text(percentageIslamicGreaterThanTen.toFixed(2) + "%");
                $('#civics-percentageGTen, #civics-percentageGTenSucces').text(percentageCivicsGreaterThanTen.toFixed(2) + "%");
                $('#historyandgeography-percentageGTen, #historyandgeography-percentageGTenSucces').text(percentageHistoryAndGeographyGreaterThanTen.toFixed(2) + "%");
                $('#math-percentageGTen, #math-percentageGTenSucces').text(percentageMathGreaterThanTen.toFixed(2) + "%");
                $('#nature-percentageGTen, #nature-percentageGTenSucces').text(percentageNatureGreaterThanTen.toFixed(2) + "%");
                $('#physical-percentageGTen, #physical-percentageGTenSucces').text(percentagePhysicalGreaterThanTen.toFixed(2) + "%");
                $('#informatics-percentageGTen, #informatics-percentageGTenSucces').text(percentageInformaticsGreaterThanTen.toFixed(2) + "%");
                $('#fine-percentageGTen, #fine-percentageGTenSucces').text(percentageFineGreaterThanTen.toFixed(2) + "%");
                $('#music-percentageGTen, #music-percentageGTenSucces').text(percentageMusicGreaterThanTen.toFixed(2) + "%");
                $('#athletic-percentageGTen, #athletic-percentageGTenSucces').text(percentageAthleticGreaterThanTen.toFixed(2) + "%");
                $('#rate-percentageGTen, #rate-percentageGTenSucces').text(percentageRateGreaterThanTen.toFixed(2) + "%");
            ...
            table.rows().every(function() {
                ...
                table.rows().every(function () {
                    ...
                    const islamicValue = parseFloat(rowData['التربية الإسلامية']) || 0;
                    const civicsValue = parseFloat(rowData['التربية المدنية']) || 0;
                    const historyGeographyValue = parseFloat(rowData['التاريخ والجغرافيا']) || 0;
                    const mathValue = parseFloat(rowData['الرياضيات']) || 0;
                    const natureValue = parseFloat(rowData['ع الطبيعة و الحياة']) || 0;
                    const physicalValue = parseFloat(rowData['ع الفيزيائية والتكنولوجيا']) || 0;
                    const informaticsValue = parseFloat(rowData['المعلوماتية']) || 0;
                ...
                table.rows().every(function () {
                    ...
                    const gender = rowData['الجنس'];
                    const arabic = parseFloat(rowData['اللغة العربية']) || 0;
                    const french = parseFloat(rowData['اللغة الفرنسية']) || 0;
                    const english = parseFloat(rowData['اللغة الإنجليزية']) || 0;
                    const history = parseFloat(rowData['التاريخ والجغرافيا']) || 0;
                    const scienceTech = parseFloat(rowData['ع الفيزيائية والتكنولوجيا']) || 0;
                    const natureLife = parseFloat(rowData['ع الطبيعة و الحياة']) || 0;
                    const mathematics = parseFloat(rowData['الرياضيات']) || 0;
...
var dataAnalyse = [
    ...
    { subject: 'معدل الفصل 1', mean: meanRate.toFixed(2)},
];
